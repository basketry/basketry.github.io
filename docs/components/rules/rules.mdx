...
Common rules for building [Basketry](https://basketry.io) pipelines. These rules may be used with any Basketry parser and may be combined with any other Basketry rules.
