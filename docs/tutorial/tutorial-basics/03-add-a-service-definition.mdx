---
sidebar_position: 3
description: Use Swagger.io's Petstore example service definition
---
...
Learn more about the parsers that Basketry provides by checking out the [parser components](/docs/components/parsers).
